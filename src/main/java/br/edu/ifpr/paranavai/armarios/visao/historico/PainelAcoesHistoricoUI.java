 ...
 */
public class PainelAcoesHistoricoUI extends javax.swing.JPanel {

    /**
     * Creates new form PanelAcoes
     */
    public PainelAcoesHistoricoUI() {
        initComponents();
    }

    public void iniciarEventos(IndexHistoricoUI indexHistoricoUI, AcoesEventoTabela evento, JTable tabela, int linha){
