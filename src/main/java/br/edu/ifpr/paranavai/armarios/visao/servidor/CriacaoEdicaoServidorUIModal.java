...
public class CriacaoEdicaoServidorUIModal extends javax.swing.JDialog {
    ...
    public CriacaoEdicaoServidorUIModal(IndexServidorPanelUI indexServidorPanelUI, Servidor servidor) {
        this(indexServidorPanelUI);
        this.servidor = servidor;
        this.estaAtualizando = true;

        initTextFields(servidor);
    }

    private void initTextFields(Servidor servidor) {
        lblTitulo.setText("Edição do Servidor " + servidor.getId());
        this.setTitle("Edição do Servidor " + servidor.getId());
        txtNome.setText(servidor.getNome());
        txtSobrenome.setText(servidor.getSobrenome());
        txtSiape.setText(servidor.getSiape());
        txtTelefone.setText(servidor.getTelefone());
        txtEmail.setText(servidor.getEmail());
        txtSenha.setText(servidor.getSenha());
        txtConfirmaSenha.setText(servidor.getSenha());
        ckbAtivo.setSelected(servidor.isAtivo());
    }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSalvarActionPerformed
        ...
        this.servidor.setNome(txtNome.getText());
        this.servidor.setSobrenome(txtSobrenome.getText());
        this.servidor.setSiape(txtSiape.getText());
        this.servidor.setTelefone(txtTelefone.getText());
        this.servidor.setEmail(txtEmail.getText());
        this.servidor.setAtivo(ckbAtivo.isSelected());

        char[] caracteresSenha = this.txtSenha.getPassword();
        String senha = new String(caracteresSenha);
        if (!senha.equals(this.servidor.getSenha())) {
            String senhaCriptografada = AutenticacaoUtil.converteSenhaParaSha256Hex(senha);
            this.servidor.setSenha(senhaCriptografada);
        }
    ...
    private void salvar() throws HeadlessException {
        try {
            ServidorServico.inserir(servidor);
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, MensagemUtil.SERVIDOR_INSERCAO_ERRO_PADRAO,
    ...
    private void atualizar() {
        try {
            ServidorServico.atualizar(servidor);
