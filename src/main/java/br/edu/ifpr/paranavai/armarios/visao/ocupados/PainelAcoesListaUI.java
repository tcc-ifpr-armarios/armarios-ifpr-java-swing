 ...
 */
public class PainelAcoesListaUI extends javax.swing.JPanel {

    /**
     * Creates new form PanelAcoes
     */
    public PainelAcoesListaUI() {
        initComponents();
    }

    public void iniciarEventos(ListaOcupadosUI listaHistoricoUI, AcoesEventoTabela evento, JTable tabela, int linha){
