 ...
 */
@Entity
@Table(name = "tb_historico_saguao")
public class HistoricoSaguao {
    ...
    public HistoricoSaguao() {
    }

    public HistoricoSaguao(Integer id, int numero, Date data_Hora_Devolucao, Date dataHoraEmprestimo, String ra) {
        this.id = id;
        this.numero = numero;
